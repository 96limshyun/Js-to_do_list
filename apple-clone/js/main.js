(() => {
    ...
    function setCanvasImages() {
        let imgElem;
        for (let i = 0; i < sceneInfo[0].values.videoImageCound; i++) {
            imgElem = new Image();
        ...
        let imgElem2;
        for (let i = 0; i < sceneInfo[2].values.videoImageCound; i++) {
            imgElem2 = new Image();
    ...
    // 각 스크롤 섹션의 높이 세팅, sceneInfo[i]마다 스크롤 높이 세팅 함수
    function setLayout() {
    ...
    // 현재 씬(스크롤섹션)에서 스크롤된 범위를 비율로 구하기 함수
    ...
    function playAnimation() {
        ...
        switch (currentScene) {
            ...
            case 2:
                ...
                // currentScene3에서 쓰는 캔버스를 미리 그려주기 시작
                if (scrollRatio > 0.9) {
                    ...
                    const whiteRectWidth = recalculateInnerHeight * 0.15;
